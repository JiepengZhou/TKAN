...
best_model_path = 'best_vitmoe_cat.pth'
model = ViTKAN(image_size=(32, 6), patch_size=(4, 3), in_channels=3, num_classes=10).to(device)  # 假设你有 10 个类别
print(model)
