...
model = ViTKAN(image_size=(32, 6), patch_size=(4, 3), in_channels=1, num_classes=10).to(device)
best_model_path = 'best_vitmoe1_ini.pth'
model.load_state_dict(torch.load('best_vitmoe1_ini.pth'))
print(model)
'''
