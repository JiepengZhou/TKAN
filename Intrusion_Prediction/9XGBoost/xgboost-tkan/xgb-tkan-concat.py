...
# 数据拆分为训练集和测试集
X_train, X_test, y_train, y_test = train_test_split(X.reshape(-1, 32 * 19), y, test_size=0.2, random_state=42, stratify=y)
print()
