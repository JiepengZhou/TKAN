...
class CTKAN(nn.Module):
    def __init__(self, num_classes=10, flrn=5):
        ...
        self.feature_dim = self.densenet.classifier.in_features  # usually 1024 for DenseNet121
    ...
    def forward(self, x):
        ...
        # Extract feature map from DenseNet
        features = self.densenet.features(x)  # (B, C, H, W)
        ...
        lstm_output, _ = self.lstm(lstm_input)  # (B, H*W, 128)
