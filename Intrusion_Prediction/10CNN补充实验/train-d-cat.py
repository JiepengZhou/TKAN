...
best_model_path = 'best_d_cat.pth'
model = PureDenseNet(num_classes=10).to(device)  # 假设你有 10 个类别
# model.load_state_dict(torch.load("best_d_cat.pth"))
print(model)
