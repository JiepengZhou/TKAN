...
def train_tkan():
    ...
    for epoch in range(epochs):
        ...
        if train_loss + valid_loss <= stop_loss:
            ...
            break
     # 训练结束后保存最佳模型
    torch.save(best_model_state, 'best_TKAN132.pth')
    print("Best model saved as best_TKAN132.pth")
...
best_model.load_state_dict(torch.load('best_TKAN132.pth'))
best_model.eval()
